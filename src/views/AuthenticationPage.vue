<template>
  ...
  >
    <div class="flex h-full items-center">
      <section
        class="mx-auto w-full max-w-screen-lg rounded-lg px-1 backdrop-blur-md sm:bg-theme-section sm:bg-opacity-75 sm:px-4 sm:py-8 sm:py-8 sm:shadow-md lg:shadow-lg"
      >
        <!-- Start Wrapper -->
        <div class="flex flex-col px-2 transition-all duration-300 sm:grid sm:grid-cols-3">
          ...
          <div class="flex flex-col px-2 sm:col-span-2 sm:items-start sm:pr-8">
            ...
            <div class="flex flex-col sm:hidden">
              ...
              <cf-button class="bg-theme-primary text-sm text-theme-inverted" @click="switchForm">
