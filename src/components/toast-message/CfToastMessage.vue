<template>
  <div
    ...
    :class="`${colorClass} mb-3 flex w-full justify-between rounded-2xl p-4 shadow-sm sm:shadow-lg`"
  >
    <div class="flex">
      ...
      <div class="flex flex-col justify-center">
        ...
        <p v-if="props.title" :class="`${props.description ? 'font-bold' : 'font-regular text-lg'}`">
          {{ props.title }}
        </p>
    ...
    <div class="flex items-center">
      <cf-button class="h-6 w-6" icon @click="emit('update:modelValue', false)">
        <font-awesome-icon
