    ...
    <main-dialog as="div" class="relative z-20">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="top-32 flex min-h-[70%] items-center justify-center">
          <dialog-panel
            class="w-[93%] max-w-xl rounded-2xl bg-theme-section bg-opacity-80 p-4 text-theme-base shadow-lg ring-1 ring-theme-primary backdrop-blur-md sm:mx-0 sm:mx-auto sm:w-[60%] lg:w-[45%]"
          >
            ...
            <form id="login-modal-form" autocomplete="off" class="flex w-full flex-col justify-between" @submit.prevent>
              ...
              <div class="mt-8 mb-4 flex w-full justify-end justify-between px-2">
